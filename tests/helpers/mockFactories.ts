...
export function createMockRace(overrides: Partial<Race> = {}): Race {
  return {
    ...
    parent_race: null,
    subraces: [
      { id: 2, slug: 'phb:high-elf', name: 'High Elf' },
      { id: 3, slug: 'phb:wood-elf', name: 'Wood Elf' }
    ],
    modifiers: [
      {
...
export const wizardMockRaces = {
  ...
  human: createMockRace({
    ...
    subraces: [
      { id: 5, slug: 'phb:variant-human', name: 'Variant Human' }
    ],
    modifiers: [
  ...
  dwarf: createMockRace({
    ...
    subrace_required: true,
    subraces: [
      { id: 7, slug: 'phb:hill-dwarf', name: 'Hill Dwarf' },
      { id: 8, slug: 'phb:mountain-dwarf', name: 'Mountain Dwarf' }
    ],
    modifiers: [
      {
        modifier_category: 'ability_score',
...
export const wizardMockClasses = {
  fighter: createMockClass({
    ...
    subclass_level: 3,
    subclasses: [
      { id: 11, name: 'Champion', slug: 'phb:champion' },
      { id: 12, name: 'Battle Master', slug: 'phb:battle-master' }
    ]
  }),
  wizard: createMockClass({
    ...
    subclass_level: 2,
    subclasses: [
      { id: 2, name: 'School of Evocation', slug: 'phb:school-of-evocation' },
      { id: 3, name: 'School of Abjuration', slug: 'phb:school-of-abjuration' }
    ]
  }),
  cleric: createMockClass({
    ...
    subclass_level: 1,
    subclasses: [
      { id: 14, name: 'Life Domain', slug: 'phb:life-domain' },
      { id: 15, name: 'War Domain', slug: 'phb:war-domain' }
    ]
  })
} as const
