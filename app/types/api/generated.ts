 ...
 * Generated at: 2025-12-08T23:41:40.556Z
 *
...
export interface components {
  schemas: {
    ...
    AddCharacterClassRequest: {
      /**
             * @description Accept 'class' as API param, mapped to class_slug
    ...
    CharacterUpdateRequest: {
      name?: string
      /**
             * @description Core choices - accept API names (race, class, background) mapped to *_slug columns
             *     No exists validation - dangling references allowed per #288
             */
      race_slug?: string | null
      class_slug?: string | null
    ...
    ResolveChoiceRequest: {
      ...
      type?: 'asi' | 'feat'
      /**
             * @description Accept 'feat' as API param, mapped to feat_slug
             *     No exists validation - dangling references allowed per #288
             */
      feat_slug?: string
    ...
    SetSubclassRequest: {
      /**
             * @description Accept 'subclass' as API param, mapped to subclass_slug
             *     No exists validation - dangling references allowed per #288
             */
    ...
    /** StoreCharacterConditionRequest */
    StoreCharacterConditionRequest: {
      /**
             * @description Accept 'condition' as API param, mapped to condition_slug
             *     No exists validation - dangling references allowed per #288
             */
      condition_slug: string
      level?: number | null
    ...
    StoreEquipmentRequest: {
      /**
             * @description Accept 'item' as API param, mapped to item_slug
             *     No exists validation - dangling references allowed per #288
...
export interface operations {
  ...
  'characters.asi-choice': {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['AsiChoiceRequest']
      }
    }
    responses: {
  ...
  'importCharacter': {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['ImportCharacterRequest']
      }
    }
    responses: {
      200: {
  ...
  'characters.classes.store': {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['AddCharacterClassRequest']
      }
    }
    responses: {
      200: {
  ...
  'characters.classes.replace': {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['ReplaceCharacterClassRequest']
      }
    }
    responses: {
      200: {
  ...
  'characters.classes.set-subclass': {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['SetSubclassRequest']
      }
    }
    responses: {
      200: {
  ...
  'characters.conditions.store': {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['StoreCharacterConditionRequest']
      }
    }
    responses: {
